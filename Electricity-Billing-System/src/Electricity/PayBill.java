...
public class PayBill extends JFrame implements ActionListener{
    ...
    PayBill(String meter){
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(rs.getString("status").equals("Paid")) paid=true;
                else paid = false;
            }
        }catch(Exception e){}
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            if(paid){ JOptionPane.showMessageDialog(null, "You have no due bills at this month, Please select another month!!!");}
            else{
                try{
                    String st = "Not,"+meter+","+c1.getSelectedItem();
                    FileWriter myWriter = new FileWriter("C:\\Users\\lenovo\\OneDrive\\Documents\\NetBeansProjects\\"
                        ...
                        myWriter.write(st);
                        myWriter.close();
                    Runtime.getRuntime().exec("C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe http://localhost:8004/project1/payment.jsp");
