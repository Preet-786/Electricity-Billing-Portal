...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/ma3.jpg"));
        ...
        ImageIcon icon55 = new ImageIcon(ClassLoader.getSystemResource("icon/icon1.png"));
        Image image55 = icon1.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
        m5.setIcon(new ImageIcon(image55));
        m5.setMnemonic('D');
        m5.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, ActionEvent.CTRL_MASK));
        ...
        ImageIcon iconabt = new ImageIcon(ClassLoader.getSystemResource("icon/icon10.png"));
        Image imageabt = iconabt.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
        abt.setIcon(new ImageIcon(imageabt));
        abt.setMnemonic('O');
        abt.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            try{
                Runtime.getRuntime().exec("C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe  http://localhost:8004/project1/about.jsp");
            }catch(Exception e){ }
        }
